...
In order to support loading of multiple wallets in kabberry-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is kabberry.cpp.
...
Changes to kabberry.cpp
----------------------
kabberry.cpp is the entry point into kabberry-qt, and as such, will require some minor modifications to provide hooks for
